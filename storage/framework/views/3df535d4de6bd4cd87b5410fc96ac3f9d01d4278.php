        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <li><button class="btn btn-danger"><a href="<?php echo e(route('formations')); ?>" id="men">Nos Formations</a></button></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Simplon-Burkina-master2\resources\views/partials/header.blade.php ENDPATH**/ ?>